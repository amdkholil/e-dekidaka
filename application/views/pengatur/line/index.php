<div class="card">
	<div class="card-header">
		<a href="<?= site_url() ?>pengaturan">Pengaturan</a> / Line
		...
		<table class="table table-sm table-hover table-bordered table-striped">
			...
			<tr class="text-center">
				<td width="80">
					...
					<a href="<?= site_url('pengaturan/line/del/').$row->id ?>" class="btn btn-sm btn-danger"
...
<div class="modal fade" id="m-line" tabindex="-1" role="dialog" aria-labelledby="b-line" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<form method="POST" action="<?= site_url() ?>pengaturan/line/add">
...
<div class="modal fade" id="m-lineEdit" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<form method="POST" action="<?= site_url() ?>pengaturan/line/edit">
				<div class="modal-header">
					<h6>Edit Line</h6>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
